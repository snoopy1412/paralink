...
>(({ className, children, closable = true, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {closable && (
        <DialogPrimitive.Close className="absolute right-[20px] top-[22px] rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
